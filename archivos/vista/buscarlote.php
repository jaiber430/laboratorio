...
<head>
    ...
    <title>Sistema Laboratorio - Buscar Lotes</title>
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <div class="container mt-4">
                    <input type="text" id="verlotes" name="verlotes" class="form-control mb-2" placeholder="Consultar Lotes" required>
                    <button type="button" id="buscarlote" name="buscarlote" class="btn btn-primary" style="cursor:pointer;">
                        Buscar Lote
                    </button>
                    <div id="mostrarlote" class="mt-3"></div>
                </div>
            </div>
        </div>
    </div>
