        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <div class="container mt-4">
                    <input type="text" id="datos" name="datos" class="form-control mb-2" placeholder="Consultar usuarios" required>
                    <button type="button" id="buscar" name="buscar" class="btn btn-primary" style="cursor:pointer;">
                        Buscar
                    </button>
                    <div id="usuario" class="mt-3"></div>
                </div>
            </div>
        </div>
    </div>
